<header class="main-header">
        <!-- Logo -->
        <a href="<?=base_index();?>" class="logo"><b>Submission System </b></a>
...
<div class="modal modal-warning" id="informasi" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="z-index:1050"> <div class="modal-dialog"> <div class="modal-content"><div class="modal-header"> <h4 class="modal-title"><?=$lang['info'];?></h4> </div> <div class="modal-body"> <p id="isi_informasi">
<?=$lang['session_over'];?>
