...
?>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_abstract" method="post" class="form-horizontal" action="<?=base_admin();?>modul/submission/submission_admin/change_status.php?act=up_abstract">
...
'Rejected' => 'Rejected',
                     ...
                     foreach ($option as $isi => $val) {
                        ...
                        if ($data_edit->status_abstract==$isi) {
