...
<input type="hidden" name="presenter_name_old" value="<?=$data_edit->presenter_name;?>">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea id="editboxs" name="content_abstract" class="editboxs"required><?=$data_edit->content_abstract;?> </textarea>
              </div>
          </div><!-- /.form-group -->
