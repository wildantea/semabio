              ...
              <section class="content-header">
                  <h1>Profile</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $lang["edit"];?> Profile</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title"><?php echo $lang["edit"];?> Profile</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_profile" method="post" class="form-horizontal" action="<?=base_admin();?>modul/profile/profile_action.php?act=up">
                            
              <div class="form-group">
                <label for="id_scope" class="control-label col-lg-2">id_scope </label>
                <div class="col-lg-10">
                  <input type="text" name="id_scope" value="<?=$data_edit->id_scope;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
