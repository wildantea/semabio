...
$datatable2->setDebug(1);
  ...
  foreach ($query as $value) {
    ...
    if (in_array($_SESSION['group_level'],$array_login)) {
      $login_as = '<a href="'.base_admin().'inc/login_as.php?id='.$value->id_user.'&adm_id=1" class="btn btn-success btn-sm" data-toggle="tooltip" title="" data-original-title="Login As Peserta/Presenter"><i class="fa fa-user"></i></a>';
    }
    if ($_SESSION['group_level']!='reviewer') {
