<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li><a href="<?=base_index();?>data-reviewer">Data Reviewer</a></li>
                        <li class="active">Detail Data Reviewer</li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Data Reviewer</h3>
              ...
              <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <img src="<?=base_url();?>upload/back_profil_foto/<?=$data_edit->foto_user?>" class="myImage"></div>
                  </div>
                  </div>
                      </div><!-- /.form-group -->
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php if ($data_edit->aktif=="Y") {
                  ...
                  <?php
                      ...
                      <a href="<?=base_index();?>data-reviewer" class="btn btn-success "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
