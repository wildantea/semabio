<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
              <a href="<?=base_index();?>user-managements">Data Reviewer</a>
            </li>
            <li class="active"><?php echo $lang["add_button"];?> Data Reviewer</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title"><?php echo $lang["add_button"];?> Reviewer</h3>
...
<input type="hidden" name="group_level" value="reviewer">
          <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
             <a href="<?=base_index();?>data-reviewer" class="btn btn-default "><i class="fa fa-step-backward"></i> <?php echo $lang["cancel_button"];?></a>
