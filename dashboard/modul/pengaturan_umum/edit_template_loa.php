  ...
  .center-ckeditor textarea {
   ...
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
           ...
           <form id="edit_template" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pengaturan_umum/pengaturan_umum_action.php?act=up_template_loa">
    ...
    <span class="copy-btn" data-type="text" data-text="{{qr_code}}"><i class="fa fa-copy"></i>Qr Code</span>
              ...
              <div class="form-group">
                <div class="col-lg-12 center-ckeditor">
                 <textarea id="editor1" name="isi_template_surat"><?=$data_edit->template_loa ;?></textarea>
                </div>
              </div><!-- /.form-group -->
