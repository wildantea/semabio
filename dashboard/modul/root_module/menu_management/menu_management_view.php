...
function read_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/root_module/menu_management/menu_management_action.php?act=change_read",
...
function insert_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/root_module/menu_management/menu_management_action.php?act=change_insert",
        data: "role_id="+id+"&data_act="+check_act,
     //  enctype:  'multipart/form-data'
      success: function(data){
...
function update_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/root_module/menu_management/menu_management_action.php?act=change_update",
        data: "role_id="+id+"&data_act="+check_act,
     //  enctype:  'multipart/form-data'
      success: function(data){
...
function delete_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/root_module/menu_management/menu_management_action.php?act=change_delete",
        data: "role_id="+id+"&data_act="+check_act,
     //  enctype:  'multipart/form-data'
      success: function(data){
...
function import_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/root_module/menu_management/menu_management_action.php?act=change_import",
        data: "role_id="+id+"&data_act="+check_act,
     //  enctype:  'multipart/form-data'
      success: function(data){
