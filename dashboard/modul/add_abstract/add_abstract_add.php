<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
              <a href="<?=base_index();?>add-abstract">Add Abstract</a>
            </li>
            <li class="active"><?php echo $lang["add_button"];?> Add Abstract</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add New Abstract</h3>
        ...
        <form id="input_add_abstract" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/submission/abstract/abstract_action.php?act=in">
            ...
            <select  id="id_user" name="id_user" data-placeholder="Pilih User ..." class="form-control chzn-select" tabindex="2" required>
               <option value=""></option>
               <?php foreach ($db->query("select * from sys_users where group_level='presenter'") as $isi) {
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea id="content_abstract" name="content_abstract" class="editbox" required=""></textarea>
              </div>
          </div><!-- /.form-group -->
            ...
            <select  id="id_scope" name="id_scope" data-placeholder="Pilih Topic ..." class="form-control chzn-select" tabindex="2" required>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="presenter_name" placeholder="Presenter" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
