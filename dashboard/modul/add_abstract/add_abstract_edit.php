              ...
              <section class="content-header">
                  <h1>Add Abstract</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $lang["edit"];?> Add Abstract</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title"><?php echo $lang["edit"];?> Add Abstract</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_add_abstract" method="post" class="form-horizontal" action="<?=base_admin();?>modul/add_abstract/add_abstract_action.php?act=up">
