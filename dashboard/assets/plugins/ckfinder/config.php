...
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_backends
 ...
 $modul_dir = explode(DIRECTORY_SEPARATOR, __DIR__);
     array_pop($modul_dir);
     array_pop($modul_dir);
      array_pop($modul_dir);
       array_pop($modul_dir);
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $modul_dir.'/upload/web_foto_upload/',
    //'root'         => '/var/www/html/semabio/upload/web_foto_upload/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => '/var/www/html/semabio/upload/web_foto_upload/',
    'maxSize'           => 0,
    ...
    'deniedExtensions'  => 'exe,com,msi,bat,cgi,pl,php,phps,phar,php7,php5,phtml,php3,php4,php5,php6,py,pyc,pyo,pcgi,pcgi3,pcgi4,pcgi5,pchi6',
    'backend'           => 'default'
);
