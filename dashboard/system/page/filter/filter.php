...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                  ...
                  <div class="box-body">
                        <form class="form-horizontal" id="inputss" action="<?=base_admin();?>system/page/filter/create_filter.php" method="post">
   ...
   $(".btn-remove").click(function(){
    ...
    return false;
     ...
     $(".tipe").change(function(){
        ...
        if (val=='select') {
        $.ajax({
          url: "<?=base_admin();?>system/page/filter/from_db.php",
     ...
     $(".type_content").on('change','.from',function(){
         ...
         tb = obj.val();
            if (tb!='') {
            $.ajax({
          url: "<?=base_admin();?>system/page/filter/isi_on.php?tb="+tb,
          success:function(data){
...
//console.log( $(this);
 ...
 // $("tr.row_new select").select2();
  ...
  function tipe(val,col)
  {
    ...
    if (val=='select') {
        $.ajax({
      url: "<?=base_admin();?>system/page/filter/from_db.php?col="+col,
      success:function(data){
